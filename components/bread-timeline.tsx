...
const COPY: Record<Locale, {
  ...
  cs: {
    ...
    story: {
      ...
      peceni: "Nejdřív pečení v páře, pak dopečení v suchu dokřupava. Kůrka vznikne až v posledních minutách.",
      steamStep: "Prvních 18 minut se peče v páře. Ta drží povrch bochníku vláčný, aby se v troubě mohl ještě roztáhnout — bez páry by se kůrka zatáhla dřív, než těsto stihne vyjít. Pak se pára odpustí a chleba dopeče dokřupava.",
      predani: "Chleba musí vychladnout, jinak se střída uvnitř srazí. Teprve dvě hodiny po pečení je opravdu hotový.",
    },
  },
  en: {
    ...
    story: {
      ...
      peceni: "Baked in steam first, then finished dry until crisp. The crust only forms in the final minutes.",
      steamStep: "The first 18 minutes are baked in steam. It keeps the surface of the loaf supple so it can still expand in the oven — without steam the crust would set before the dough had risen. Then the steam is released and the bread finishes until crisp.",
      predani: "Bread has to cool down, otherwise the crumb collapses inside. Only two hours after baking is it truly done.",
    },
  },
  de: {
    ...
    story: {
      ...
      peceni: "Zuerst mit Dampf backen, dann trocken knusprig fertig backen. Die Kruste entsteht erst in den letzten Minuten.",
      steamStep: "Die ersten 18 Minuten wird mit Dampf gebacken. Er hält die Oberfläche des Laibs geschmeidig, damit er im Ofen noch aufgehen kann — ohne Dampf würde die Kruste fest werden, bevor der Teig aufgehen kann. Danach wird der Dampf abgelassen und das Brot bäckt knusprig fertig.",
      predani: "Brot muss auskühlen, sonst fällt die Krume innen zusammen. Erst zwei Stunden nach dem Backen ist es wirklich fertig.",
    },
  },
}
